class LessonPaymentsController < ApplicationController
  before_action :set_lesson_payment, only: [:show, :edit, :update, :destroy]

  # GET /lesson_payments
  # GET /lesson_payments.json
  def index
    @lesson_payments = LessonPayment.all
  end

  # GET /lesson_payments/1
  # GET /lesson_payments/1.json
  def show
  end
  ...
  # PATCH/PUT /lesson_payments/1.json
  def update
    respond_to do |format|
